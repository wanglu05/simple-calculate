...
public class Constants {
     ...
     * 请勿随意更改位置,会使用到索引位置
     */
    public static final String[] PUBLIC_AREA_SYSTEM_VARIABLE = {"表计类型", "表属性", "仪表编号", "仪表名称", "是否反向", "仪表倍率", "初始读数", "分摊方式", "初始化年份", "初始化累计用量", "收费项目", "收费标准"};

    /**
     * 公区表抄表信息系统变量
     * 请勿随意更改位置,会使用到索引位置
     */
    public static final String[] PUBLIC_AREA_READ_SYSTEM_VARIABLE = {"公区表_本次止数", "公区表_新表起数", "公区表_新表止数", "公区表_损耗", "公区表_本次抄表日期", "公区表_用量", "公区表_旧表用量", "公区表_合计用量", "公区表_本年累计用量", "公区表_单价", "公区表_应收金额"};

    /**
     * 基础信息系统变量
     * 请勿随意更改位置,会使用到索引位置
     */
    public static final String[] BASIS_SYSTEM_VARIABLE = {"分摊户数", "小区名称", "楼栋名称", "单元名称", "楼层", "房间编号", "门牌号", "房间属性", "房间类型", "是否公区", "建筑面积", "交房状态", "结算状态", "客户姓名", "联系方式", "证件类型", "证件号", "客户身份"};
